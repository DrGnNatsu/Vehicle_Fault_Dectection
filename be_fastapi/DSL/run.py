...
def runTest():
    ...
    from CompiledFiles.CameraLexer import CameraLexer
    from CompiledFiles.CameraParser import CameraParser
    ...
    for fileName in os.listdir("./tests"):
        ...
        print("List of token: ")
        lexer = CameraLexer(FileStream(inputFile))
        tokens = []
        ...
        lexer = CameraLexer(input_stream)
        stream = CommonTokenStream(lexer)
        parser = CameraParser(stream)
        ...
        parser = CameraParser(token_stream)
