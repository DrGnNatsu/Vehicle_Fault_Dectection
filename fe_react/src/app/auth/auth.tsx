...
export function Registration() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("[v0] Registration submitted", { email, password, confirmPassword })
  }

  return (
    <AuthLayout>
      <div>
        <h2 className="text-blue-700 dark:text-sky-400 text-xl font-bold">Create an account</h2>
        <p className="text-gray-700 dark:text-gray-200 text-sm">Get started with MynaUI today.</p>
      </div>
...
export function Reset1() {
  ...
  return (
    <AuthLayout>
      <div>
        <h2 className="text-blue-700 dark:text-sky-400 text-xl font-bold">Reset Password</h2>
